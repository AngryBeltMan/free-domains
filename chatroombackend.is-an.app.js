...
addSubDomain({
  description: 'chatroom', // describe your project in this field
  domain: 'is-an.app', // aka "root-domain". select between '1bt.uk' and 'is-an.app'
  subdomain: 'chatroombackend', // desired subdomain name
  owner: {
    repo: '<https://URL/to/the/repository/with/your/project/sources/if/it/is/public>',
    email: '<your-public@email.address>',
  },
  record: {
    CNAME: 'https://chatroom-backend-x12y.onrender.com', // e.g.: <your-github-account>.github.io
